...
from microver import CameraRelay, input


def handle_input(joystick: JoystickType, ser: Serial) -> None:
...
def main() -> None:
    ...
    camera_relay = CameraRelay(resolution=(800, 600))
    ...
    try:
        ser = input.connect_serial("/dev/ttyACM0", 115200)
        while True:
